...
readFilePromise(fileName)
  .then(data => {
    ...
    // we can send promise down by returning the invocation then result from this promise gets sent down to another .then
    // this method returns a promise to avoid nested callback function
